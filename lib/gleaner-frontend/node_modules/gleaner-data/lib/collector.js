                            ...
                            return traces_.find(query).then(function(records) {
                                if(records) {
                                    ...
                                    for (var level in levels) {
                                        ...
                                        if(levels[level].correct + levels[level].wrong) {
            ...
            return profiles.find({email: email}, true).then(function(profile) {
                if(profile) {
                    return authTokens.track(profile.authToken).then(function(authToken) {
                        ...
                        // 3. Add the the number of basic elearning linsk clicked
                        ...
                        // 4. Add the highscore of this user and return
                        ...
                        return traces_.find({user: email, event: "login"}).then(function(records) {
                            ...
                            // 7. Calculate the experience towards the next level
                            var progress = 0;
                            switch (level) {
                                case 0:
